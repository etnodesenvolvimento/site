...
function ChatModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-end md:items-center justify-center bg-ink/60 backdrop-blur-sm p-0 md:p-6"
      onClick={onClose}
    >
      <div
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-ink/10 bg-cream">
          <div>
            <div className="text-[10px] uppercase tracking-widest text-ink/50 font-bold">
              Luhara · IA do SNE 2026
            </div>
            <div className="text-lg font-bold text-ink">
              Converse com a Luára
            </div>
          </div>
          <button
            onClick={onClose}
            className="w-9 h-9 rounded-full hover:bg-ink/10 text-ink text-xl flex items-center justify-center"
          >
            ×
          </button>
        </div>
        ...
        >
          ...
          {loading && (
            <div className="flex justify-start">
              <div className="bg-ink/5 text-ink/60 px-4 py-3 rounded-2xl text-sm">
                Luhara pensando…
              </div>
            </div>
          )}
        ...
        <div className="border-t border-ink/10 p-3 bg-cream">
          ...
          <div className="text-[10px] text-ink/40 mt-2 text-center">
