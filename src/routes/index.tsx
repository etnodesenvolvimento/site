...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      {
        title:
          "Seminário Nacional de Etnodesenvolvimento — Santa Maria-RS/Brasil 2026",
      },
      {
        name: "description",
        content:
          "11 de julho de 2026 · FEICOOP — Santa Maria/RS Ancestralidade, Território e Desenvolvimento para um Brasil Plural In Memoriam Jorge da Silva Nascimento.",
      },
      {
        property: "og:title",
        content: "Seminário Nacional de Etnodesenvolvimento",
      },
      {
        property: "og:description",
        content:
          "Ancestralidade, Território e Desenvolvimento para um Brasil Plural — Santa Maria-RS/Brasil, 11 de julho de 2026",
      },
    ],
  }),
  component: Index,
...
const day1: Block[] = [
  { time: "13h30", title: "Acolhimento", track: 4, rows: 1 },
  {
    ...
    title: "Abertura",
    subtitle:
      "Composição da mesa de autoridades, organização da FEICOOP e movimentos sociais",
    track: 5,
    rows: 1,
  },
  {
    time: "14h30",
    title: "Painel 1: Mulheres do FESPOPE e o Etnodesenvolvimento",
    subtitle:
  ...
  },
  {
    time: "15h",
    title:
      "Painel 2: Desafios decoloniais do Etnodesenvolvimento em um mundo em transformação",
    subtitle: "Lucas Alberto Santos",
    track: 2,
    rows: 2,
  },
  { time: "15h45", title: "Coffee Break", track: 2, rows: 1 },
  {
    time: "16h",
    title:
      "Feijão de Ogum: Feira do Etnodesenvolvimento e Educação Financeira Afrocentrada",
    subtitle:
      "Experiências de Organização e Autonomia do Povo de Terreiro · Paulo Azarias",
    track: 3,
    rows: 2,
  },
  {
    time: "16h30",
    title: "Conexão, encaminhamentos e encerramento",
    track: 5,
    rows: 1,
  },
];
...
const speakers: Speaker[] = [
  {
    ...
    miniBio:
      "Militante da Economia Popular Solidária, fundadora do FESPOPE-RS e integrante de redes e coletivos de mulheres negras. Atua como educadora popular, articuladora social e palestrante nas áreas de economia solidária, igualdade racial, feminismo negro e comércio justo.",
    fullBio: [
  ...
  },
  {
    ...
    miniBio:
      "Militante histórico do Movimento Negro Unificado (MNU), diretor do COMPIR de Juiz de Fora (MG) e fundador do Feijão de Ogum. Atua há mais de 30 anos na promoção da igualdade racial, no combate ao racismo e na defesa das religiões de matriz africana.",
    fullBio: [
...
function AgendaBlock({ b }: { b: Block }) {
  const span =
    b.rows === 1 ? "row-span-1" : b.rows === 2 ? "row-span-2" : "row-span-3";
  return (
    <div
      className={`${trackBg[b.track]} ${span} relative p-4 md:p-5 flex flex-col rounded-sm transition-transform hover:scale-[1.02] hover:z-10 hover:shadow-xl cursor-default`}
    >
      {b.time && (
        <span className="text-xs font-bold uppercase tracking-wider opacity-70 text-ink">
          {b.time}
        </span>
      )}
      <div className="mt-3">
        <h4 className="text-base md:text-lg font-bold text-ink leading-tight">
          {b.title}
        </h4>
        {b.subtitle && (
          <p className="mt-2 text-xs md:text-sm text-ink/80 leading-snug">
            {b.subtitle}
          </p>
        )}
      </div>
        ...
        <div className="grid md:grid-cols-5">
          <div className="md:col-span-2 aspect-square md:aspect-auto md:h-full">
            <img
              src={speaker.img}
              alt={speaker.name}
              className="w-full h-full object-cover object-[50%_20%] grayscale"
            />
          </div>
          <div className="md:col-span-3 p-6 md:p-8">
            ...
            <h3 className="mt-1 text-2xl md:text-3xl font-bold text-ink leading-tight">
              {speaker.name}
            </h3>
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 bg-cream/90 backdrop-blur border-b border-ink/10">
        <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-6 text-sm font-medium text-ink/70">
            ...
            <a href="#homenageado" className="hover:text-ink">
              Homenageado
            </a>
            <a href="#programacao" className="hover:text-ink">
              Programação
            </a>
            <a href="#palestrantes" className="hover:text-ink">
              Palestrantes
            </a>
            <a href="#local" className="hover:text-ink">
              Local
            </a>
          </div>
          <a
      ...
      <section className="bg-cream text-ink">
        ...
        <div className="max-w-7xl mx-auto px-6 pb-20 md:pb-32 pt-6 md:pt-10">
          <h1 className="text-[2.75rem] md:text-[5.5rem] lg:text-[6.5rem] leading-[1.02] tracking-tight max-w-6xl font-light">
            <span className="block text-[9px] md:text-[10px] font-bold uppercase tracking-[0.25em] text-ink/50 mb-2">
              In Memoriam Jorge da Silva Nascimento (Jorjão)
            </span>
            Seminário Nacional
            <br />
          ...
          <div className="mt-16 flex flex-wrap gap-10 items-end">
            ...
            <div>
              ...
              <div className="text-xl font-bold mt-1">
                FEICOOP · Santa Maria — RS/Brasil
              </div>
            </div>
            <a
              href="#inscricao"
              className="ml-auto bg-ink text-cream px-8 py-4 text-sm font-bold rounded-sm hover:opacity-90 transition"
            >
          ...
          <div className="mt-36 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-14 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start">
              <div className="text-xs font-bold uppercase tracking-[0.3em] text-ink/50 mb-3">
                Nossa IA
              </div>
              <div
                className="text-6xl md:text-8xl font-light text-ink mb-8"
                style={{
        ...
        <div className="grid md:grid-cols-12 gap-10">
          <div className="md:col-span-4">
            ...
            <h2 className="mt-3 text-4xl md:text-5xl text-ink">
              Um espaço de diálogo e produção de conhecimento
            </h2>
          </div>
          <div className="md:col-span-8 space-y-5 text-lg leading-relaxed text-ink/80">
            <p>
              ...
              reúne pesquisadores, estudantes, gestores públicos, lideranças
              comunitárias e organizações sociais para refletir sobre
              experiências, desafios e perspectivas do etnodesenvolvimento no
              Brasil.
            </p>
            <p>
              Voltado aos povos e comunidades tradicionais, população negra,
              povos indígenas e comunidades quilombolas, o evento promove o
              fortalecimento de políticas públicas e a valorização da
              pluralidade brasileira.
            </p>
            <p>
              Uma tarde de palestras, mesas-redondas e relatos de experiências.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-4 flex items-baseline gap-4 flex-wrap">
              <h2 className="text-4xl md:text-6xl font-light">
                Jorge da Silva Nascimento
              </h2>
            </div>
            <p className="mt-2 text-lg opacity-60 italic">"Jorjão"</p>
            <h3 className="mt-8 text-2xl md:text-3xl font-bold">
              Quatro décadas pela igualdade.
            </h3>
            <p className="mt-6 text-lg leading-relaxed opacity-80">
              Educador popular, pesquisador social e liderança comunitária,
              Jorge dedicou mais de quarenta anos à promoção da igualdade
              racial, da educação popular e do fortalecimento das comunidades
              tradicionais.
            </p>
            <p className="mt-4 text-lg leading-relaxed opacity-80">
              Idealizador de projetos de desenvolvimento territorial
              participativo, tornou-se referência nacional na defesa dos
              direitos humanos e do protagonismo das populações historicamente
              marginalizadas.
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28">
        ...
        <h2 className="mt-3 text-4xl md:text-6xl text-ink max-w-4xl">
          Ancestralidade, Território e Desenvolvimento para um{" "}
          <span className="text-accent">Brasil Plural</span>
        </h2>
        <p className="mt-8 text-lg md:text-xl max-w-3xl text-ink/70 leading-relaxed">
          Como a valorização da identidade dos povos tradicionais contribui para
          modelos sustentáveis de desenvolvimento, fortalecendo políticas
          públicas, inclusão social, justiça racial e preservação ambiental.
        </p>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h2 className="mt-3 text-4xl md:text-5xl mb-3">
            Quem estará com a gente
          </h2>
          <p className="mb-12 text-sm opacity-60">
            Passe o mouse para um resumo · clique no card para ler a biografia
            completa.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {speakers.map((s, i) => (
              <div
                ...
                tabIndex={0}
                onKeyDown={(e) => {
                  if (e.key === "Enter") setSelectedSpeaker(i);
                }}
              ...
              >
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-t from-ink via-ink/70 to-transparent transition-opacity duration-300 ${hovered === i ? "opacity-100" : "opacity-0"}`}
                />
                <div
                  className={`absolute inset-0 p-5 flex flex-col justify-end text-cream transition-all duration-300 ${hovered === i ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
                >
                  ...
                  <div className="mt-3 text-[10px] font-bold uppercase tracking-widest text-accent">
                    Clique para ler mais →
                  </div>
                </div>
                <div
                  className={`absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-ink/90 to-transparent transition-opacity ${hovered === i ? "opacity-0" : "opacity-100"}`}
                >
                  <div className="text-sm font-bold text-cream leading-tight">
                    {s.name}
                  </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-28">
        ...
        <h2 className="mt-3 text-4xl md:text-5xl text-ink mb-10">
          O que vamos debater
        </h2>
        <div className="flex flex-wrap gap-2">
          {eixosTematicos.map((t) => (
            <span
              key={t}
              className="px-4 py-2 border border-ink/20 text-sm text-ink hover:bg-ink hover:text-cream transition rounded-full cursor-default"
            >
              {t}
            </span>
          ))}
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-28 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-ink/70 leading-relaxed">
              Coração geográfico do Rio Grande do Sul, Santa Maria recebe o
              seminário em espaços com infraestrutura completa de
              acessibilidade.
            </p>
            <ul className="mt-6 space-y-3 text-ink/80">
              <li className="flex gap-3">
                <span className="text-accent font-bold">→</span> Espaços e
                banheiros acessíveis
              </li>
              <li className="flex gap-3">
                <span className="text-accent font-bold">→</span> Certificado de
                participação do seminário
              </li>
              <li className="flex gap-3">
                <span className="text-accent font-bold">→</span> Evento 100%
                presencial · FEICOOP
              </li>
            </ul>
          </div>
      ...
      <section
        ...
        style={{ backgroundColor: "#1f1e3a", color: "#f7f3e8" }}
      >
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="mt-4 text-lg opacity-70">
            Preencha o cadastro abaixo. Vagas limitadas.
          </p>
          ...
          <form onSubmit={handleInscricao} className="mt-10 space-y-5">
            ...
            {formStatus === "sent" && (
              <p className="text-sm text-emerald-400">
                Inscrição recebida! Em breve você receberá a confirmação por
                e-mail.
              </p>
            )}
            {formStatus === "error" && (
      ...
      <footer className="bg-ink text-cream/70 border-t border-cream/10 py-12">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8 text-sm">
          <div>
            ...
            <p className="mt-2">
              Seminário Nacional de Etnodesenvolvimento — In Memoriam Jorge da
              Silva Nascimento
            </p>
          </div>
          <div>
            <div className="font-bold text-cream uppercase tracking-widest text-xs mb-3">
              Contato
            </div>
            <p>{INSCRICAO_EMAIL}</p>
          </div>
...
function Field({
  ...
  return (
    <div>
      <label
        htmlFor={name}
        className="block text-xs uppercase tracking-widest opacity-70 mb-2"
      >
        {label}
        {required && " *"}
      </label>
